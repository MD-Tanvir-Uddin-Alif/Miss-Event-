...
from .views import CustomUserRegistrationView, VerifyView, LogoutView, UpdateProfileView, PasswordResetConfirmView, PasswordResetRequestView, ChangePasswordView
