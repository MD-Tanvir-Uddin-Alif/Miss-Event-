        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div>
            ...
            <input name="title" type="text" value={formData.title} onChange={handleChange} placeholder="Event Title"
              className="w-full px-4 py-2 border border-black rounded-lg focus:outline-none focus:ring-1 focus:ring-black bg-white text-black placeholder-gray-400" />
          </div>
          ...
          <div>
            ...
            <input name="start_time" type="datetime-local" value={formData.start_time} onChange={handleChange}
              className="w-full px-4 py-2 border border-black rounded-lg focus:outline-none focus:ring-1 focus:ring-black bg-white text-black" />
          </div>
